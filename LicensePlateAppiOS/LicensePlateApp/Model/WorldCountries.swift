...
/// Used for all countries worldwide (excluding US, Canada, Mexico which are handled separately)
struct WorldCountries {
    /// All countries as (ISO code, country name) tuples
