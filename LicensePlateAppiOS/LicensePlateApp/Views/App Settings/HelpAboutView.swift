    ...
    private var sections: [PolicySection] {
        [
            ...
            PolicySection(
                ...
                body: "Account information: a username and avatar, and — if you register — your email address. If you sign in with Google or Apple, we receive basic profile details from that provider, such as your email address, which we store privately. Gameplay data: your trips, games, license plate discoveries, XP, achievements, ranks, cosmetics, and settings. Social data: the friends and family connections you create and the invitations you send or accept. Device and usage data: device model, operating system, app version, IP address, app identifiers, push notification tokens, analytics events, and crash reports. Purchase data: your subscription and purchase status from the app store and our purchase processor — we never receive your full payment card details.".localized
            ),
            PolicySection(
